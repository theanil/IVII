...
{
    var srvURL = "http://localhost/api_ivii/Serv";
}
var version = "100";
var app_name ="IVII";
var appname = "IVII";
...
myApp.onPageInit('Bathware', function (page) {

  url = srvURL + '/category';
    $$.ajax({
          url: url,
          method: "GET",
          data: {product_type:'Bathware'},
          processData: true,
          dataType: 'json',
          timeout : 50000,
          success: function (e, status, xhr)
...
myApp.onPageInit('faucets', function (page) {

  url = srvURL + '/category';
    $$.ajax({
          url: url,
          method: "GET",
          data: {product_type:'Faucets'},
          processData: true,
          dataType: 'json',
          timeout : 50000,
          success: function (e, status, xhr)
...
myApp.onPageInit('Allied Products', function (page) {

  url = srvURL + '/category';
    $$.ajax({
          url: url,
          method: "GET",
          data: {product_type:'Allied Products'},
          processData: true,
          dataType: 'json',
          timeout : 50000,
          success: function (e, status, xhr)
...
myApp.onPageInit('designer_washbasin', function (page) {

  url = srvURL + '/category';
    $$.ajax({
          url: url,
          method: "GET",
          data: {product_type:'Designer Washbasin'},
          processData: true,
          dataType: 'json',
          timeout : 50000,
          success: function (e, status, xhr)
...
myApp.onPageInit('shower_systems', function (page) {

  url = srvURL + '/category';
    $$.ajax({
          url: url,
          method: "GET",
          data: {product_type:'Shower Systems'},
          processData: true,
          dataType: 'json',
          timeout : 50000,
          success: function (e, status, xhr)
...
myApp.onPageInit('allied_products', function (page) {
                      ...
                      //myApp.alert(myarray.indexOf(product_id))
                        ...
                        if(myarray.indexOf(product_id) != -1)   
                        {
                           ...
                           //cadd += '<span style="display: none; color: black;" id="pa_' + product_id +'">' + price + ' <a href="#" class="link" onclick="AddProduct(' + "'" + product_id +  "','" + product_name  +  "','" + product_price  + "');" + '">Add 1</a></span>';
                            ...
                            if(fact_sheet != '')
                            {
                                cadd += '<span> <a href="#" onclick="downbrochure(' + "'" + fact_sheet + "'" +');" class="link" style=""' + '"><img src="images/tech-sheet1.png"></a></span>';
                            }
                        ...
                        }else
                        {
                            ...
                            if(fact_sheet != '')
                            {
                                cadd += '<center><span> <a href="#" onclick="downbrochure(' + "'" + fact_sheet + "'" +');" class="link" style=""' + '"><img src="images/tech-sheet1.png"></a></span></center>';
                            }                          
                            //cadd += '<center>';
